...
import tech.antibytes.pixabay.sdk.fixture.StringAlphaGenerator
import tech.antibytes.pixabay.sdk.fixture.pixabayResponseFixture
import tech.antibytes.pixabay.sdk.model.PixabayResponse
import tech.antibytes.pixabay.sdk.networking.NetworkingContract
import tech.antibytes.pixabay.sdk.networking.RequestBuilderFactoryMock
import tech.antibytes.pixabay.sdk.networking.RequestBuilderMock
...
class ClientSpec {
    ...
    fun `Given fetchImages is called with a query and a page Index it returns an Error if it has no Connection`() = runBlockingTestWithTimeout {
        ...
        // Then
        response.getError()!! fulfils PixabayClientError.NoConnection::class
    }
    ...
    fun `Given fetchImages is called with a query and a page Index it propagates Errors`() = runBlockingTestWithTimeout {
        ...
        // Then
        response.getError()!! sameAs responseError
    }
